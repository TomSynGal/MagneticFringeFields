###############################################################################
# Version 10.01 Main, Last Modified, 14/12/2021
###############################################################################
import numpy as np
import matplotlib.cm as cm
import matplotlib.pyplot as plt
from V10Functions import G, bx, by, bzeta, IntegrateTrapz, NumericalFourierFit
from V10Functions import FFT, FFTFit, ScalarPotential
from V10Params import LF, FF, zLim, zLimPlot
###############################################################################
...
do_2D_Scalar_Potential_Multipole_Plots = False
...
if do_Field_Plots:
    ...
    plt.plot(fig1Range*LF, fig1Data[0,:]*FF, label = 'n=0, Dipole')
    plt.plot(fig1Range*LF, fig1Data[1,:]*FF, label = 'n=1, Quadrupole')
    plt.plot(fig1Range*LF, fig1Data[2,:]*FF, label = 'n=2, Sextupole')
    plt.plot(fig1Range*LF, fig1Data[3,:]*FF, label = 'n=3, Octupole')
    plt.plot(fig1Range*LF, fig1Data[4,:]*FF, label = 'n=4, Decapole')
    plt.xlabel(r'$z$ ($mm$)')
    ...
    for i in range (3):
        ...
        plt.clf()
        plt.title(titlesX[i])
        plt.plot(fig2Data[0,1,:]*LF, fig2Data[0,2,:]*FF, label = r'$z$ = -3')
        plt.plot(fig2Data[1,1,:]*LF, fig2Data[1,2,:]*FF, label = r'$z$ = -1.8')
        plt.plot(fig2Data[2,1,:]*LF, fig2Data[2,2,:]*FF, label = r'$z$ = -0.6')
        plt.plot(fig2Data[3,1,:]*LF, fig2Data[3,2,:]*FF, label = r'$z$ = 0.6')
        plt.plot(fig2Data[4,1,:]*LF, fig2Data[4,2,:]*FF, label = r'$z$ = 1.8')
        plt.plot(fig2Data[5,1,:]*LF, fig2Data[5,2,:]*FF, label = r'$z$ = 3')
        plt.xlabel(r'$y$ ($mm$)')
        ...
        plt.clf()
        plt.title(titlesY[i])
        plt.plot(fig3Data[0,1,:]*LF, fig3Data[0,2,:]*FF, label = r'$z$ = -3')
        plt.plot(fig3Data[1,1,:]*LF, fig3Data[1,2,:]*FF, label = r'$z$ = -1.8')
        plt.plot(fig3Data[2,1,:]*LF, fig3Data[2,2,:]*FF, label = r'$z$ = -0.6')
        plt.plot(fig3Data[3,1,:]*LF, fig3Data[3,2,:]*FF, label = r'$z$ = 0.6')
        plt.plot(fig3Data[4,1,:]*LF, fig3Data[4,2,:]*FF, label = r'$z$ = 1.8')
        plt.plot(fig3Data[5,1,:]*LF, fig3Data[5,2,:]*FF, label = r'$z$ = 3')
        plt.xlabel(r'$x$ ($mm$)')
...
if do_Fourier_Analysis:
    ...
    plt.plot(zRange*LF, dataGRe*FF, label = 'G, n = 2')
    plt.plot(zRange*LF, dataTrapRe*FF, label = 'Fourier Fit, n = 2')
    plt.xlabel(r'$z$ ($mm$)')
    ...
    plt.plot(zRange*LF, dataDiffRe*FF)
    plt.xlabel(r'$z$ ($mm$)')
    ...
    plt.plot(zRange*LF, dataGIm*FF, label = 'G, n = 2')
    plt.plot(zRange*LF, dataTrapIm*FF, label = 'Fourier Fit, n = 2')
    plt.xlabel(r'$z$ ($mm$)')
    ...
    plt.plot(zRange*LF, dataDiffIm*FF)
    plt.xlabel(r'$z$ ($mm$)')
...
if do_Fast_Fourier_Transform:
    ...
    plt.plot(vals2*LF, dataGRe2*FF, label = 'G, n = 2')
    plt.plot(vals2*LF, dataFFTRe*FF, label = 'Fast Fourier, n = 2')
    plt.xlabel(r'$z$ ($mm$)')
    plt.ylabel(r'$\Re$ (G) ($mm^{-1}$)')
    plt.legend(prop={'size': 8})
    plt.grid()
    ...
    plt.plot(vals2*LF, dataDiffRe2*FF)
    plt.xlabel(r'$z$ ($mm$)')
    plt.ylabel(r'Residual of $\Re$ (G) Fit ($mm^{-1}$)')
    plt.grid()
    ...
    plt.plot(vals2*LF, dataGIm2*FF, label = 'G, n = 2')
    plt.plot(vals2*LF, dataFFTIm*FF, label = 'Fast Fourier, n = 2')
    plt.xlabel(r'$z$ ($mm$)')
    plt.ylabel(r'$\Im$ (G) ($mm^{-1}$)')
    plt.legend(prop={'size': 8})
    plt.grid()
    ...
    plt.plot(vals2*LF, dataDiffIm2*FF)
    plt.xlabel(r'$z$ ($mm$)')
    plt.ylabel(r'Residual of $\Im$ (G) Fit ($mm^{-1}$)')
    plt.grid()
...
if do_Fourier_Comparisons:
    ...
    plt.title('Numerical Real Fourier Fit Comparison')
    plt.plot(zRange*LF, dataGRe*FF, label = 'G, n = 2')
    plt.plot(zRange*LF, dataTrapRe*FF, label = 'Numerical Fourier, n = 2')
    plt.plot(vals2*LF, dataFFTRe*FF, label = 'Fast Fourier, n = 2')
    plt.xlabel(r'$z$ ($mm$)')
    plt.ylabel(r'$\Re$ (G) ($mm^{-1}$)')
    plt.legend(prop={'size': 8})
    ...
    plt.clf()
    plt.title('Numerical Real Fourier Fit Difference')
    plt.plot(zRange*LF, dataDiffRe*FF, label = 'Numerical Fourier')
    plt.plot(vals2*LF, dataDiffRe2*FF, label = 'Fast Fourier')
    plt.xlabel(r'$z$ ($mm$)')
    plt.ylabel(r'Residual of $\Re$ (G) Fit ($mm^{-1}$)')
    plt.legend(prop={'size': 8})
    plt.grid()
    ...
    plt.title('Numerical Imaginary Fourier Fit Comparison')
    plt.plot(zRange*LF, dataGIm*FF, label = 'G, n = 2')
    plt.plot(zRange*LF, dataTrapIm*FF, label = 'Numerical Fourier, n = 2')
    plt.plot(vals2*LF, dataFFTIm*FF, label = 'Fast Fourier, n = 2')
    plt.xlabel(r'$z$ ($mm$)')
    plt.ylabel(r'$\Im$ (G) ($mm^{-1}$)')
    plt.legend(prop={'size': 8})
    ...
    plt.clf()
    plt.title('Numerical Imaginary Fourier Fit Difference')
    plt.plot(zRange*LF, dataDiffIm*FF, label = 'Numerical Fourier')
    plt.plot(vals2*LF, dataDiffIm2*FF, label = 'Fast Fourier')
    plt.xlabel(r'$z$ ($mm$)')
    plt.ylabel(r'Residual of $\Im$ (G) Fit ($mm^{-1}$)')
    plt.legend(prop={'size': 8})
    plt.grid()
...
if do_FFT_Scalar_Potential:
    ...
    scalarGrad = np.gradient(scalarPotData, zRange)
    #scalarGrad = scalarGrad*gradFactor # Differentiate numerically  which alters the z scale.
    
    plt.clf()
    plt.title(r'Sextupole $\mathrm{\mathbb{Re}}$ Bz Component as a Function of z')
    plt.plot(zRange*LF, np.real(bzData)*FF, label = r'$\mathrm{\mathbb{Re}}$ Bz')
    plt.xlabel(r'$z$ ($mm$)')
    ...
    plt.plot(zRange*LF, np.real(scalarPotData)*FF, label = r'$\mathrm{\mathbb{Re}}$ $\phi$')
    plt.xlabel(r'$z$ ($mm$)')
    ...
    plt.plot(zRange*LF, np.real(scalarGrad)*FF, label = r'$\partial_z$ ($\mathrm{\mathbb{Re}}$ $\phi$)')
    plt.xlabel(r'$z$ ($mm$)')
    ...
    plt.plot(zRange*LF, np.real(bxData)*FF, label = r'$\mathrm{\mathbb{Re}}$ Bx')
    plt.plot(zRange*LF, (BXfactor*np.real(scalarPotData))*FF, label = r'$\mathrm{\mathbb{Re}}$ $\phi$')
    plt.xlabel(r'$z$ ($mm$)')
    ...
    plt.clf()
    plt.title(r'Sextupole $\mathrm{\mathbb{Re}}$ Bx and $\partial_x$ ($\mathrm{\mathbb{Re}}$ $\phi$) component as a function of z')
    plt.plot(zRange*LF, (np.real(bxData)-(BXfactor*np.real(scalarPotData)))*FF, label = r'$\mathrm{\mathbb{Re}}$ Bx')
    plt.xlabel(r'$z$ ($mm$)')
    plt.ylabel(r'$\Re$ $B_{x}$ , $\Re$ $\partial_x$($\phi$) ($mT$)')
    plt.grid()
    ...
    plt.plot(zRange*LF, np.real(byData)*FF, label = r'$\mathrm{\mathbb{Re}}$ By')
    plt.plot(zRange*LF, (BYfactor*np.real(scalarPotData))*FF, label = r'$\mathrm{\mathbb{Re}}$ $\phi$')
    plt.xlabel(r'$z$ ($mm$)')
    ...
    plt.clf()
    plt.title(r'Sextupole $\mathrm{\mathbb{Re}}$ By and $\partial_y$ ($\mathrm{\mathbb{Re}}$ $\phi$) component as a function of z')
    plt.plot(zRange*LF, (np.real(byData)-(BYfactor*np.real(scalarPotData)))*FF, label = r'$\mathrm{\mathbb{Re}}$ By')
    plt.xlabel(r'$z$ ($mm$)')
    plt.ylabel(r'$\Re$ $B_{y}$ , $\Re$ $\partial_y$($\phi$) ($mT$)')
    plt.grid()
    ...
    plt.clf()
    plt.title(r'Sextupole $\mathrm{\mathbb{Re}}$ Bz and $\partial_z$ ($\mathrm{\mathbb{Re}}$ $\phi$) scalar potential component as a function of z')
    plt.plot(zRange*LF, (np.real(bzData)-np.real(scalarGrad))*FF, label = r'$\mathrm{\mathbb{Re}}$ $\phi$')
    plt.xlabel(r'$z$ ($mm$)')
    plt.ylabel(r'$\Re$ $B_{z}$ , $\Re$ $\partial_z$($\phi$) ($mT$)')
    plt.grid()

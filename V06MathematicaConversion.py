...
from V06MathematicaFunctions import G, bx, by, IntegrateTrapz
from V06MathematicaFunctions import NumericalFourierFit, FFT, FFTFit
from V06MathematicaFunctions import ScalarPotential
##############################################################################
...
zVals = np.linspace(-50, 50, 101)
length = len(zVals)
npts = 31
dataset = np.zeros([101])
...
for i in range(length):
    ...
    dataPoint = ScalarPotential(1, 1, z, bjArray, npts, 100, n)

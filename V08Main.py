##############################################################################
# Version 8.01 Main, Last Modified, 02/12/2021
##############################################################################
import numpy as np
import matplotlib.cm as cm
import matplotlib.pyplot as plt
from V08Functions import G, bx, by, bzeta, IntegrateTrapz, NumericalFourierFit
from V08Functions import FFT, FFTFit, ScalarPotential
from V08Params import zLim, zLimPlot
##############################################################################
...
do_3D_Scalar_Potential_Multipole_Plots = True
...
if do_2D_Scalar_Potential_Multipole_Plots:
    ...
    fourierRes = 31#51 #201
    nFourierCoeffs = 21#35 #45
